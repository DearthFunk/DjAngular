...
*/
    ...
    scanDevices = function(){
		...
		//-------------------TDS - MOD FOR USE IN REFRESHING OF DEVICES
	    inputs = [];
	    outputs =[];
	    //-------------------TDS - OTHERWISE IT JUST APPENDS TO THE LIST INSTEAD OF CLEARING FIRST

		var name,
			list;

        //get inputs
        if (typeof Jazz.MidiInList === 'function') {
		...
		else {console.log("no Jazz plugin installed!");}
    };
